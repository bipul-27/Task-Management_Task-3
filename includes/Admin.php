...
class FFB_Admin {
    ...
    public function admin_menu() {
        ...
        $hook = add_menu_page( 
            __( 'Boards <span class="items-number">'.count($boards).'</span>', 'fluent-features-board' ), 
            __( 'Boards <span class="items-number">'.count($boards).'</span>', 'fluent-features-board' ), 
            $capability, 
            $slug, 
        ...
        $submenu = add_submenu_page( 
            $slug, 
            __('Lists <span class="items-number">'.count($requestLists).'</span>', 'fluent-features-board'), 
            __('Lists <span class="items-number">'.count($requestLists).'</span>', 'fluent-features-board'),
            $capability, 
